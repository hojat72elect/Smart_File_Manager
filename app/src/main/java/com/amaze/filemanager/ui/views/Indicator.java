...
public class Indicator extends View implements View.OnAttachStateChangeListener {
    ...
    private Path getUnselectedPath(
        ...
        if (dotRevealFraction > MINIMAL_REVEAL) {
            ...
            unselectedDotPath.addCircle(
                    centerX, dotCenterY, dotRevealFraction * dotRadius, Path.Direction.CW);
        }
    ...
    private ValueAnimator createMoveSelectedAnimator(
        ...
        moveSelected.addUpdateListener(
                valueAnimator -> {
            ...
            addUpdateListener(
                    valueAnimator -> {
                        ...
                        setDotRevealFraction(
                                PendingRevealAnimator.this.dot, (Float) valueAnimator.getAnimatedValue());
                    });
            addListener(
                    new AnimatorListenerAdapter() {
                        @Override
